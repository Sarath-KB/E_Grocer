...
<html>
    <head>
        ...
        <title>Delivery Agent Requests</title>
    </head>
    <body>
        <%
        ...
        <table border="1" style="border-collapse:collapse;">
            ...
            %>
                    <tr>
                        ...
                        <td><a href="DeliveryAgentList-New.jsp?acid=<%=rs.getString("da_id")%>&email=<%=rs.getString("da_email")%>">Accept</a>/<a href="DeliveryAgentList-New.jsp?reid=<%=rs.getString("da_id")%>&email=<%=rs.getString("da_email")%>">Reject</a></td>
                    </tr>
            <%
                }while(rs.next());
            %>
