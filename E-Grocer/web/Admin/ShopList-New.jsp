<%-- 
    Document   : ShopList-New
    Created on : Apr 5, 2021, 2:38:15 PM
    Author     : HP
--%>
    ...
    <body>
        <%
            if(request.getParameter("acid")!=null){
                ...
                response.sendRedirect("ShopList-New.jsp");
            }
            if(request.getParameter("reid")!=null){
                String up="update tbl_shop set shop_status=2 where shop_id='"+request.getParameter("reid")+"'";
                con.executeCommand(up);
                response.sendRedirect("ShopList-New.jsp");
            }
            ...
            %>
                <tr>
                    ...
                    <td><img src="../Assets/Shop/<%=rs.getString("idproof") %>" width="80" height="80" alt="Owner ID Proof"></td>
                        <td><a href="ShopList-New.jsp?acid=<%=rs.getString("shop_id")%>">Accept</a>/<a href="ShopList-New.jsp?reid=<%=rs.getString("shop_id")%>">Reject</a></td>
                    </tr>
            <%
                }while(rs.next());
            %>
