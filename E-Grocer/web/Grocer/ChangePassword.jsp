        ...
        <form method="POST">
            ...
            <%
                if(request.getParameter("btn_submit")!=null){
                    String sel = "select * from tbl_shop where shop_id='"+session.getAttribute("userid")+"'"
                               + "and shop_pwd='"+request.getParameter("txt_currentpwd")+"'";
                    ResultSet rs = con.selectCommand(sel);
                    if(rs.next()){
                        if(request.getParameter("txt_newpwd").equals(request.getParameter("txt_confpwd"))){
                            String upd = "update tbl_shop set shop_pwd='"+request.getParameter("txt_newpwd")+"'" 
