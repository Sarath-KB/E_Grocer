<%-- 
    ...
    Created on : Apr 19, 2021, 2:48:51 PM
    Author     : HP
--%>
            ...
            <%
                if(request.getParameter("btn_submit")!=null){
                    String sel = "select * from tbl_user where user_id='"+session.getAttribute("userid")+"'"
                               + "and password='"+request.getParameter("txt_currentpwd")+"'";
                    ResultSet rs = con.selectCommand(sel);
                    if(rs.next()){
                        if(request.getParameter("txt_newpwd").equals(request.getParameter("txt_confpwd"))){
                            String upd = "update tbl_user set password='"+request.getParameter("txt_newpwd")+"'" 
            ...
            <table align="center" border="1" cellpadding="10" style="border-collapse:collapse;">
                ...
                <tr>
                    <td colspan="2" align="center">
                        ...
                        <input type="reset" name="btn_submit" value="Cancel"/>
                    </td>
                </tr>
