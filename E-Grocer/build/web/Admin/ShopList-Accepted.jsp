    ...
    <body>
        ...
        <%
            if(request.getParameter("reid")!=null){
                String upd="update tbl_shop set shop_status=2 where shop_id='"+request.getParameter("reid")+"'";
                con.executeCommand(upd);
                response.sendRedirect("ShopList-Accepted.jsp");
            }
        ...
        <table border="1" style="border-collapse:collapse;">
            ...
            %>
                <tr>
                    ...
                    <td><a href="ShopList-Accepted.jsp?reid=<%=rs.getString("shop_id")%>">Remove</a></td>
                </tr>
            <%
                }while(rs.next());
            %>
