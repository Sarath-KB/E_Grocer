    ...
    <body>
        ...
        <%            
            String qry ="select * from tbl_shop shp inner join tbl_place pl on shp.place_id=pl.place_id"
                       ...
                       +" where shop_id='"+request.getParameter("fwdid")+"'";
        ...
        <form method="POST">
            ...
            <table align="center" border="1" cellpadding="10" style="border-collapse:collapse;" >
                ...
                <tr>
                    <td colspan="2"><h1><%=rs.getString("shop_name") %></h1><img src="../Assets/Shop/<%=rs.getString("shop_img") %>" width="80" height="80" align="right" alt="Shop Photo"></td>  
                </tr>
